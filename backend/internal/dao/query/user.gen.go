...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Ysid = field.NewInt64(tableName, "ysid")
	_user.Name = field.NewString(tableName, "name")
	_user.RealName = field.NewString(tableName, "real_name")
	_user.PwdHash = field.NewString(tableName, "pwd_hash")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Ysid = field.NewInt64(table, "ysid")
	u.Name = field.NewString(table, "name")
	u.RealName = field.NewString(table, "real_name")
	u.PwdHash = field.NewString(table, "pwd_hash")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["ysid"] = u.Ysid
	u.fieldMap["name"] = u.Name
	u.fieldMap["real_name"] = u.RealName
	u.fieldMap["pwd_hash"] = u.PwdHash
